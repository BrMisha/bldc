...
void hw_init_gpio(void) {
	...
	// Light
	palSetPadMode(LIGHT_GPIO, LIGHT_PIN, PAL_MODE_OUTPUT_PUSHPULL | PAL_STM32_OSPEED_LOWEST);
	palSetPadMode(LIGHT_LONG_GPIO, LIGHT_LONG_PIN, PAL_MODE_OUTPUT_PUSHPULL | PAL_STM32_OSPEED_LOWEST);
	palSetPadMode(TURN_LEFT_GPIO, TURN_LEFT_PIN, PAL_MODE_OUTPUT_PUSHPULL | PAL_STM32_OSPEED_LOWEST);
	palSetPadMode(TURN_RIGHT_GPIO, TURN_RIGHT_PIN, PAL_MODE_OUTPUT_PUSHPULL | PAL_STM32_OSPEED_LOWEST);
	// Set the lights off
	LIGHT_OFF();
	LIGHT_LONG_OFF();
	TURN_LEFT_OFF();
